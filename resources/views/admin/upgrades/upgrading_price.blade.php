                        ...
                        <div class="ml-4 mt-4 mb-2 mr-4">
                            <form method="post" action="{{ route('admin.pricing') }}">
                                ...
                                <div class="form-group row">
                                    <label for="inputAddress2" class="col-sm-2 col-form-label">Top 10 Placement</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="placement_cost" 
                                            placeholder="Enter Cost">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputAddress2" class="col-sm-2 col-form-label">Featured Ad</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="inputAddress2" class="col-sm-2 col-form-label">Animated Gif</label>
                                    <div class="col-sm-10">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        $jsonData = $names;
                                        $all_price = json_decode($jsonData);
                                        
                                    @endphp
                                    @foreach ($all_price as $all_prices)
                                        @php
                                            $countryName = $all_prices->country[0]->name;
                                            $stateName = $all_prices->state[0]->name;
                                            $cityName = $all_prices->city[0]->name;
                                        @endphp

                                        <tr>
                                            <td scope="col"> {{ $cityName }} / {{ $stateName }} </td>
                                            ...
                                            <td scope="col">
                                                <a
                                                    href="{{ route('upgeade_delete', ['id' => $all_prices->id]) }}">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
