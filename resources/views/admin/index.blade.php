      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu">
          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
            ...
            <img src="{{ asset('/admin-assets/assets/img/profile_img/admin/') }}/{{auth()->user()->pro_img}}" class="user-image img-circle elevation-2" alt="User Image"> 
            @endif         
          </a>
          <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <!-- User image -->
            <li class="user-header bg-primary">
              <img src="{{ asset('/admin-assets/assets/img/profile_img/admin/') }}/{{auth()->user()->pro_img}}" class="img-circle elevation-2" alt="User Image">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <!----All-Users----->
            <li class="nav-item">
              <a href="{{route('all_user')}}" class="nav-link {{ (Route::currentRouteName() == 'all_user') ? 'active' : ''; }}">
            ...
            <!----All-Subadmin----->
            <li class="nav-item {{ (Route::currentRouteName() == 'admin.all_subadmin') ? 'menu-open' : ''; }}">
              <a href="#" class="nav-link {{ (Route::currentRouteName() == 'admin.all_subadmin') ? 'active' : ''; }}">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('admin.all_subadmin')}}" class="nav-link {{ (Route::currentRouteName() == 'admin.all_subadmin') ? 'active' : ''; }}">
            ...
            <!----All-Blogs----->
            <li class="nav-item">
              <a href="{{route('all_blog')}}" class="nav-link {{ (Route::currentRouteName() == 'all_blog') ? 'active' : ''; }}">
                <i class="nav-icon fa fa-users"></i>
                <p>Blogs</p>
              </a>
            </li>
            ...
            <li class="nav-item {{ (Route::currentRouteName() == 'admin.all_subadmin') ? 'menu-open' : ''; }}">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('privacy')}}" class="nav-link {{ (Route::currentRouteName() == 'admin.all_subadmin') ? 'active' : ''; }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Privacy Policy</p>
                  </a>
                </li>
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('terms_conditions')}}" class="nav-link {{ (Route::currentRouteName() == 'admin.all_subadmin') ? 'active' : ''; }}">
                    <i class="far fa-circle nav-icon"></i>
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{route('faq.index')}}" class="nav-link {{ (Route::currentRouteName() == 'admin.all_subadmin') ? 'active' : ''; }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>FAQ</p>
                  </a>
                </li>
